      ...
      <PageHero
        ...
        title={
          <>
            ...
            <br />
            <span className="text-crimson">of ORIGINA.</span>
          </>
        }
        ...
        <SplitSection reverse>
          <div>
            <h2 className="section-title">
              An R&D organization,
              <br />
              <span className="text-crimson">not a label.</span>
            </h2>
            <LeadCopy>
        ...
        <div className="grid gap-6 border-t border-rule pt-6 sm:grid-cols-2 lg:grid-cols-5">
          {labsContinuum.map((item) => (
            <article key={item.title} className="institutional-panel">
              ...
              <strong className="mt-2 block font-serif text-xl text-ink">{item.title}</strong>
