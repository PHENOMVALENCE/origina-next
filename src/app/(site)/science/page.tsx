          ...
          <div className="space-y-6">
            ...
            <ul className="grid gap-2 sm:grid-cols-2">
              {researchConsiderations.map((item) => (
                <li key={item} className="border-l border-gold/30 pl-3 text-sm text-graphite/90">
                  {item}
                </li>
              ))}
            </ul>
            ...
            <div>
              <p className="mb-2 text-[0.62rem] uppercase tracking-[0.14em] text-stone">Factors that matter</p>
